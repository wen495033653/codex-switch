        ...
        <section className="settings-section">
            <div className="settings-about-card-grid">
                <div className="settings-about-card">
                    ...
                    <span className="settings-about-card-kicker">{t('作者')}</span>
                ...
                <button type="button" className="settings-about-card" onClick={openRepository}>
                    ...
                    <span className="settings-about-card-kicker">{t('开源地址')}</span>
                    <span className="settings-about-card-title">{t('查看代码')} <span aria-hidden="true">↗</span></span>
                </button>
                ...
                <button type="button" className="settings-about-card" onClick={onOpenGptPool}>
                    ...
                    <span className="settings-about-card-kicker">{t('中转站')}</span>
                    <span className="settings-about-card-title">{t('访问站点')}</span>
                </button>
                ...
                <button type="button" className="settings-about-card" onClick={() => setSupportVisible(true)}>
                    ...
                    <span className="settings-about-card-kicker">{t('赞助支持')}</span>
                    <span className="settings-about-card-title">{t('支持作者')}</span>
                </button>
            </div>
            ...
            <div className="settings-about-list">
                ...
                <div className="settings-about-row">
                    ...
                    <span className="settings-about-version-actions">
                        ...
                        <button type="button" className="btn btn-secondary" onClick={() => handleCheckUpdate(true)} disabled={checkingUpdate}>
    ...
    return (
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
            <div className="modal-content support-dialog" role="dialog" aria-modal="true" aria-labelledby="support-dialog-title">
                ...
                <h3 className="support-dialog-title" id="support-dialog-title">{t('赞助支持')}</h3>
                <p className="support-dialog-desc">
                    {t('如果您觉得本工具对您有帮助，欢迎扫码请作者喝杯咖啡！您的支持是我持续维护项目的最大动力。')}
                </p>
                    ...
                    {SUPPORT_QR_CODES.map(item => (
                        <div className="support-qr-card" key={item.label}>
                            <div className="support-qr-frame">
                                <img src={item.src} alt={t('{label}收款二维码', { label: t(item.label) })} decoding="async" />
                            </div>
